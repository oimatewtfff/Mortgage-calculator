...
## Техническое задание [PostMan](https://documenter.getpostman.com/view/6802079/UVeAvonG)
...
Пример API который нужно реализовать(с примерами) [PostMan](https://documenter.getpostman.com/view/6802079/UVeAvonG)
